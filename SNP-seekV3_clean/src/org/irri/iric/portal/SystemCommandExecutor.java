...
public class SystemCommandExecutor
{
  ...
  throws IOException, InterruptedException
  {
    ...
    try
    {
      ...
      if(inputStreamHandler==null) {
		  AppContext.debug("executeCommand.inputStreamHandler==null");
	  }
      if(errorStreamHandler==null) {
		  AppContext.debug("executeCommand.errorStreamHandler==null");
	  }
  ...
  public Object[] executeCommand2()
		  throws IOException, InterruptedException
		  {
		    ...
		    try
		    {
		      ...
		      retarray[0]= Integer.valueOf(exitValue);
		      retarray[1]=inputStreamHandler.getOutputBuffer();
		      retarray[2]=errorStreamHandler.getOutputBuffer();
  ...
  {
	  if(inputStreamHandler==null) {
		  AppContext.debug("inputStreamHandler==null");
	  }
  ...
  {
	  if(errorStreamHandler==null) {
		  AppContext.debug("errorStreamHandler==null");
	  }
