...
public class Object2StringMatrixRenderer implements MatrixRenderer, SNPRowRendererStyle {
	...
	public Object2StringMatrixRenderer(VariantStringData data, GenotypeQueryParams params) {
		super();
	...
	public String renderCell(Component owner, Object data, // List<String> data,
		...
		try {
			...
			if (colIndex > (frozenCols - 1)) {
				...
				if (obj[colIndex] instanceof Number)
					return String.valueOf(obj[colIndex]);
			...
			if (rowIndex == 0 || (rowIndex == 2 && params.isbShowNPBPositions())) {
				...
				if (colIndex >= frozenCols) {
					if (params.isbIndel() && params.isbAlignIndels()) { // tabledata.hasIndel()) {
						...
						/*
						 * if(setHeaderPosGapRegion.contains(BigDecimal.valueOf(
						 * Double.valueOf(posvalueonly))) ) color = "green"; else if(
						 * setHeaderPosDeletionRegion.contains(Long.valueOf(posvalueonly)) ) color =
						 * "blue";
						 */
						 ...
						 * if(setHeaderPosGapRegion.contains(BigDecimal.valueOf(
						 * Double.valueOf(posvalueonly))) ) color = "green"; else if(
						 * setHeaderPosDeletionRegion.contains(BigDecimal.valueOf(Double.valueOf(
						 * posvalueonly))) ) color = "blue";
						 */
