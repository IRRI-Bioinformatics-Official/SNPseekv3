...
import org.irri.iric.ds.chado.domain.impl.SnpsAllvarsPosImpl;
import org.irri.iric.ds.chado.domain.object.SnpsAllvarsPosSorter;
...
public class VariantIndelStringData extends VariantStringData {
	...
	private Map<Position, String> ***REMOVED***;
	// private Map<Integer,String> ***REMOVED***;
		...
		if (alignedVariantIndelStringData == null) {
			...
			***REMOVED*** = new TreeMap();
			...
			while (itPos2.hasNext()) {
				...
				***REMOVED***.put(pos2, pos2.getRefnuc());
			}
			 ...
			 * " to "+ refnuc); pos2.setRefnuc( refnuc); } ***REMOVED***.put(pos2,
			...
			if (alignallvars) {
				...
				while (itPos.hasNext()) {
					...
					// ***REMOVED***.put(idxcount, String.valueOf( sequence.charAt(
			...
			// alignedVariantIndelStringData.setMapIndelIdx2Refnuc(***REMOVED***);
			alignedVariantIndelStringData.setMapIndelpos2Refnuc(***REMOVED***);
			...
			if (AppContext.isLocalhost()) {
				AppContext.debug("***REMOVED***=" + ***REMOVED***.size());
	...
	//
	//
	// public void setMapIndelIdx2Refnuc(Map<Integer, String> ***REMOVED***) {
	...
	public void setMapIndelpos2Refnuc(Map<Position, String> ***REMOVED***) {
		this.***REMOVED*** = ***REMOVED***;
	}
