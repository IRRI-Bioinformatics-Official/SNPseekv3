...
public class DatatypeMaps {
	  ...
	  public static Map[] getDatatypesHeirarchy() {
		  
		  if(mapHeir!=null) return mapHeir;
		
		  Map<String,Set> mapFname2Class=new TreeMap();
		  Map<String,Set> mapFname2Ext=new TreeMap();
		  
		  mapHeir=new Map[] {mapFname2Class, mapFname2Ext};
			
		  Set  annotation= new LinkedHashSet();
		  Set  annotation_ext = new LinkedHashSet();
		  mapFname2Class.put("annotation",annotation);
		  mapFname2Ext.put("annotation",annotation_ext );
		  annotation.add("SnapHmm(Text)");
		  annotation_ext.add("snaphmm");
		  annotation.add("Augustus(CompressedArchive)");
		  annotation_ext.add("augustus");
		  Set  anvio= new LinkedHashSet();
		  Set  anvio_ext = new LinkedHashSet();
		  mapFname2Class.put("anvio",anvio);
		  mapFname2Ext.put("anvio",anvio_ext );
		  anvio.add("AnvioComposite(Html)");
		  anvio_ext.add("anvio_composite");
		  anvio.add("AnvioDB(AnvioComposite)");
		  anvio_ext.add("anvio_db");
		  anvio.add("AnvioStructureDB(AnvioDB)");
		  anvio_ext.add("anvio_structure_db");
		  anvio.add("AnvioGenomesDB(AnvioDB)");
		  anvio_ext.add("anvio_genomes_db");
		  anvio.add("AnvioContigsDB(AnvioDB)");
		  anvio_ext.add("anvio_contigs_db");
		  anvio.add("AnvioProfileDB(AnvioDB)");
		  anvio_ext.add("anvio_profile_db");
		  anvio.add("AnvioPanDB(AnvioDB)");
		  anvio_ext.add("anvio_pan_db");
		  anvio.add("AnvioSamplesDB(AnvioDB)");
		  anvio_ext.add("anvio_samples_db");
		  Set  assembly= new LinkedHashSet();
		  Set  assembly_ext = new LinkedHashSet();
		  mapFname2Class.put("assembly",assembly);
		  mapFname2Ext.put("assembly",assembly_ext );
		  assembly.add("Amos(data.Text)");
		  assembly_ext.add("afg");
		  assembly.add("Sequences(sequence.Fasta)");
		  assembly_ext.add("sequences");
		  assembly.add("Roadmaps(data.Text)");
		  assembly_ext.add("roadmaps");
		  assembly.add("Velvet(Html)");
		  assembly_ext.add("velvet");
		  Set  binary= new LinkedHashSet();
		  Set  binary_ext = new LinkedHashSet();
		  mapFname2Class.put("binary",binary);
		  mapFname2Ext.put("binary",binary_ext );
		  binary.add("Binary(data.Data)");
		  binary.add("Ab1(Binary)");
		  binary_ext.add("ab1");
		  binary.add("Idat(Binary)");
		  binary_ext.add("idat");
		  binary.add("Cel(Binary)");
		  binary_ext.add("cel");
		  binary.add("MashSketch(Binary)");
		  binary_ext.add("msh");
		  binary.add("CompressedArchive(Binary)");
		  binary_ext.add("compressed_archive");
		  binary.add("DynamicCompressedArchive(CompressedArchive)");
		  binary.add("GzDynamicCompressedArchive(DynamicCompressedArchive)");
		  binary.add("Bz2DynamicCompressedArchive(DynamicCompressedArchive)");
		  binary.add("CompressedZipArchive(CompressedArchive)");
		  binary_ext.add("zip");
		  binary.add("GenericAsn1Binary(Binary)");
		  binary_ext.add("asn1-binary");
		  binary.add("BamNative(CompressedArchive)");
		  binary_ext.add("unsorted.bam");
		  binary.add("Bam(BamNative)");
		  binary_ext.add("bam");
		  binary.add("ProBam(Bam)");
		  binary_ext.add("probam");
		  binary.add("BamInputSorted(BamNative)");
		  binary_ext.add("qname_input_sorted.bam");
		  binary.add("BamQuerynameSorted(BamInputSorted)");
		  binary_ext.add("qname_sorted.bam");
		  binary.add("CRAM(Binary)");
		  binary_ext.add("cram");
		  binary.add("BaseBcf(CompressedArchive)");
		  binary.add("Bcf(BaseBcf)");
		  binary_ext.add("bcf");
		  binary.add("BcfUncompressed(BaseBcf)");
		  binary_ext.add("bcf_uncompressed");
		  binary.add("H5(Binary)");
		  binary_ext.add("h5");
		  binary.add("Loom(H5)");
		  binary_ext.add("loom");
		  binary.add("GmxBinary(Binary)");
		  binary_ext.add("");
		  binary.add("Trr(GmxBinary)");
		  binary_ext.add("trr");
		  binary.add("Cpt(GmxBinary)");
		  binary_ext.add("cpt");
		  binary.add("Xtc(GmxBinary)");
		  binary_ext.add("xtc");
		  binary.add("Biom2(H5)");
		  binary_ext.add("biom2");
		  binary.add("Cool(H5)");
		  binary_ext.add("cool");
		  binary.add("Scf(Binary)");
		  binary_ext.add("scf");
		  binary.add("Sff(Binary)");
		  binary_ext.add("sff");
		  binary.add("BigWig(Binary)");
		  binary_ext.add("bigwig");
		  binary.add("BigBed(BigWig)");
		  binary_ext.add("bigbed");
		  binary.add("TwoBit(Binary)");
		  binary_ext.add("twobit");
		  binary.add("SQlite(Binary)");
		  binary_ext.add("sqlite");
		  binary.add("GeminiSQLite(SQlite)");
		  binary_ext.add("gemini.sqlite");
		  binary.add("CuffDiffSQlite(SQlite)");
		  binary_ext.add("cuffdiff.sqlite");
		  binary.add("MzSQlite(SQlite)");
		  binary_ext.add("mz.sqlite");
		  binary.add("BlibSQlite(SQlite)");
		  binary_ext.add("blib");
		  binary.add("IdpDB(SQlite)");
		  binary_ext.add("idpdb");
		  binary.add("GAFASQLite(SQlite)");
		  binary_ext.add("gafa.sqlite");
		  binary.add("Xlsx(Binary)");
		  binary_ext.add("xlsx");
		  binary.add("ExcelXls(Binary)");
		  binary_ext.add("excel.xls");
		  binary.add("Sra(Binary)");
		  binary_ext.add("sra");
		  binary.add("RData(Binary)");
		  binary_ext.add("rdata");
		  binary.add("OxliBinary(Binary)");
		  binary.add("OxliCountGraph(OxliBinary)");
		  binary_ext.add("oxlicg");
		  binary.add("OxliNodeGraph(OxliBinary)");
		  binary_ext.add("oxling");
		  binary.add("OxliTagSet(OxliBinary)");
		  binary_ext.add("oxlits");
		  binary.add("OxliStopTags(OxliBinary)");
		  binary_ext.add("oxlist");
		  binary.add("OxliSubset(OxliBinary)");
		  binary_ext.add("oxliss");
		  binary.add("OxliGraphLabels(OxliBinary)");
		  binary_ext.add("oxligl");
		  binary.add("PostgresqlArchive(CompressedArchive)");
		  binary_ext.add("postgresql");
		  binary.add("Fast5Archive(CompressedArchive)");
		  binary_ext.add("fast5.tar");
		  binary.add("Fast5ArchiveGz(Fast5Archive)");
		  binary_ext.add("fast5.tar.gz");
		  binary.add("Fast5ArchiveBz2(Fast5Archive)");
		  binary_ext.add("fast5.tar.bz2");
		  binary.add("SearchGuiArchive(CompressedArchive)");
		  binary_ext.add("searchgui_archive");
		  binary.add("NetCDF(Binary)");
		  binary_ext.add("netcdf");
		  binary.add("Dcd(Binary)");
		  binary_ext.add("dcd");
		  binary.add("Vel(Binary)");
		  binary_ext.add("vel");
		  binary.add("DAA(Binary)");
		  binary_ext.add("daa");
		  binary.add("RMA6(Binary)");
		  binary_ext.add("rma6");
		  binary.add("DMND(Binary)");
		  binary_ext.add("dmnd");
		  binary.add("ICM(Binary)");
		  binary_ext.add("icm");
		  binary.add("BafTar(CompressedArchive)");
		  binary_ext.add("brukerbaf.d.tar");
		  binary.add("YepTar(BafTar)");
		  binary_ext.add("agilentbrukeryep.d.tar");
		  binary.add("TdfTar(BafTar)");
		  binary_ext.add("brukertdf.d.tar");
		  binary.add("MassHunterTar(BafTar)");
		  binary_ext.add("agilentmasshunter.d.tar");
		  binary.add("MassLynxTar(BafTar)");
		  binary_ext.add("watersmasslynx.raw.tar");
		  binary.add("WiffTar(BafTar)");
		  binary_ext.add("wiff.tar");
		  Set  blast= new LinkedHashSet();
		  Set  blast_ext = new LinkedHashSet();
		  mapFname2Class.put("blast",blast);
		  mapFname2Ext.put("blast",blast_ext );
		  blast.add("BlastXml(GenericXml)");
		  blast_ext.add("blastxml");
		  blast.add("_BlastDb(Data)");
		  blast.add("BlastNucDb(_BlastDb, Data)");
		  blast_ext.add("blastdbn");
		  blast.add("BlastProtDb(_BlastDb, Data)");
		  blast_ext.add("blastdbp");
		  blast.add("BlastDomainDb(_BlastDb, Data)");
		  blast_ext.add("blastdbd");
		  Set  checkers= new LinkedHashSet();
		  Set  checkers_ext = new LinkedHashSet();
		  mapFname2Class.put("checkers",checkers);
		  mapFname2Ext.put("checkers",checkers_ext );
		  Set  chrominfo= new LinkedHashSet();
		  Set  chrominfo_ext = new LinkedHashSet();
		  mapFname2Class.put("chrominfo",chrominfo);
		  mapFname2Ext.put("chrominfo",chrominfo_ext );
		  chrominfo.add("ChromInfo(galaxy.datatypes.tabular.Tabular)");
		  chrominfo_ext.add("len");
		  Set  constructive_solid_geometry= new LinkedHashSet();
		  Set  constructive_solid_geometry_ext = new LinkedHashSet();
		  mapFname2Class.put("constructive_solid_geometry",constructive_solid_geometry);
		  mapFname2Ext.put("constructive_solid_geometry",constructive_solid_geometry_ext );
		  constructive_solid_geometry.add("Ply(object)");
		  constructive_solid_geometry.add("PlyAscii(Ply, data.Text)");
		  constructive_solid_geometry_ext.add("plyascii");
		  constructive_solid_geometry.add("PlyBinary(Ply, Binary)");
		  constructive_solid_geometry_ext.add("plybinary");
		  constructive_solid_geometry.add("Vtk(object)");
		  constructive_solid_geometry.add("VtkAscii(Vtk, data.Text)");
		  constructive_solid_geometry_ext.add("vtkascii");
		  constructive_solid_geometry.add("VtkBinary(Vtk, Binary)");
		  constructive_solid_geometry_ext.add("vtkbinary");
		  constructive_solid_geometry.add("STL(data.Data)");
		  constructive_solid_geometry_ext.add("stl");
		  Set  coverage= new LinkedHashSet();
		  Set  coverage_ext = new LinkedHashSet();
		  mapFname2Class.put("coverage",coverage);
		  mapFname2Ext.put("coverage",coverage_ext );
		  coverage.add("LastzCoverage(Tabular)");
		  coverage_ext.add("coverage");
		  Set  data= new LinkedHashSet();
		  Set  data_ext = new LinkedHashSet();
		  mapFname2Class.put("data",data);
		  mapFname2Ext.put("data",data_ext );
		  data.add("DataMeta(abc.ABCMeta)");
		  data.add("Data(object)");
		  data_ext.add("data");
		  data.add("Text(Data)");
		  data_ext.add("txt");
		  data.add("Directory(Data)");
		  data.add("GenericAsn1(Text)");
		  data_ext.add("asn1");
		  data.add("LineCount(Text)");
		  data.add("Newick(Text)");
		  data_ext.add("newick");
		  data.add("Nexus(Text)");
		  data_ext.add("nex");
		  Set  genetics= new LinkedHashSet();
		  Set  genetics_ext = new LinkedHashSet();
		  mapFname2Class.put("genetics",genetics);
		  mapFname2Ext.put("genetics",genetics_ext );
		  genetics.add("GenomeGraphs(Tabular)");
		  genetics_ext.add("gg");
		  genetics.add("rgTabList(Tabular)");
		  genetics_ext.add("rgTList");
		  genetics.add("rgSampleList(rgTabList)");
		  genetics_ext.add("rgSList");
		  genetics.add("rgFeatureList(rgTabList)");
		  genetics_ext.add("rgFList");
		  genetics.add("Rgenetics(Html)");
		  genetics_ext.add("rgenetics");
		  genetics.add("SNPMatrix(Rgenetics)");
		  genetics_ext.add("snpmatrix");
		  genetics.add("Lped(Rgenetics)");
		  genetics_ext.add("lped");
		  genetics.add("Pphe(Rgenetics)");
		  genetics_ext.add("pphe");
		  genetics.add("Fphe(Rgenetics)");
		  genetics_ext.add("fphe");
		  genetics.add("Phe(Rgenetics)");
		  genetics_ext.add("phe");
		  genetics.add("Fped(Rgenetics)");
		  genetics_ext.add("fped");
		  genetics.add("Pbed(Rgenetics)");
		  genetics_ext.add("pbed");
		  genetics.add("ldIndep(Rgenetics)");
		  genetics_ext.add("ldreduced");
		  genetics.add("Eigenstratgeno(Rgenetics)");
		  genetics_ext.add("eigenstratgeno");
		  genetics.add("Eigenstratpca(Rgenetics)");
		  genetics_ext.add("eigenstratpca");
		  genetics.add("Snptest(Rgenetics)");
		  genetics_ext.add("snptest");
		  genetics.add("IdeasPre(Html)");
		  genetics_ext.add("ideaspre");
		  genetics.add("Pheno(Tabular)");
		  genetics_ext.add("pheno");
		  genetics.add("RexpBase(Html)");
		  genetics_ext.add("rexpbase");
		  genetics.add("Affybatch(RexpBase)");
		  genetics_ext.add("affybatch");
		  genetics.add("Eset(RexpBase)");
		  genetics_ext.add("eset");
		  genetics.add("MAlist(RexpBase)");
		  genetics_ext.add("malist");
		  genetics.add("LinkageStudies(Text)");
		  genetics.add("GenotypeMatrix(LinkageStudies)");
		  genetics_ext.add("alohomora_gts");
		  genetics.add("MarkerMap(LinkageStudies)");
		  genetics_ext.add("linkage_map");
		  genetics.add("DataIn(LinkageStudies)");
		  genetics_ext.add("linkage_datain");
		  genetics.add("AllegroLOD(LinkageStudies)");
		  genetics_ext.add("allegro_fparam");
		  Set  graph= new LinkedHashSet();
		  Set  graph_ext = new LinkedHashSet();
		  mapFname2Class.put("graph",graph);
		  mapFname2Ext.put("graph",graph_ext );
		  graph.add("Xgmml(xml.GenericXml)");
		  graph_ext.add("xgmml");
		  graph.add("Sif(tabular.Tabular)");
		  graph_ext.add("sif");
		  graph.add("XGMMLGraphDataProvider(dataproviders.hierarchy.XMLDataProvider)");
		  graph.add("SIFGraphDataProvider(dataproviders.column.ColumnarDataProvider)");
		  Set  images= new LinkedHashSet();
		  Set  images_ext = new LinkedHashSet();
		  mapFname2Class.put("images",images);
		  mapFname2Ext.put("images",images_ext );
		  images.add("Image(data.Data)");
		  images_ext.add("");
		  images.add("Jpg(Image)");
		  images_ext.add("jpg");
		  images.add("Png(Image)");
		  images_ext.add("png");
		  images.add("Tiff(Image)");
		  images_ext.add("tiff");
		  images.add("Hamamatsu(Image)");
		  images_ext.add("vms");
		  images.add("Mirax(Image)");
		  images_ext.add("mrxs");
		  images.add("Sakura(Image)");
		  images_ext.add("svslide");
		  images.add("Nrrd(Image)");
		  images_ext.add("nrrd");
		  images.add("Bmp(Image)");
		  images_ext.add("bmp");
		  images.add("Gif(Image)");
		  images_ext.add("gif");
		  images.add("Im(Image)");
		  images_ext.add("im");
		  images.add("Pcd(Image)");
		  images_ext.add("pcd");
		  images.add("Pcx(Image)");
		  images_ext.add("pcx");
		  images.add("Ppm(Image)");
		  images_ext.add("ppm");
		  images.add("Psd(Image)");
		  images_ext.add("psd");
		  images.add("Xbm(Image)");
		  images_ext.add("xbm");
		  images.add("Xpm(Image)");
		  images_ext.add("xpm");
		  images.add("Rgb(Image)");
		  images_ext.add("rgb");
		  images.add("Pbm(Image)");
		  images_ext.add("pbm");
		  images.add("Pgm(Image)");
		  images_ext.add("pgm");
		  images.add("Eps(Image)");
		  images_ext.add("eps");
		  images.add("Rast(Image)");
		  images_ext.add("rast");
		  images.add("Pdf(Image)");
		  images_ext.add("pdf");
		  images.add("Gmaj(data.Data)");
		  images_ext.add("gmaj.zip");
		  images.add("Html(HtmlFromText)");
		  images.add("Laj(data.Text)");
		  images_ext.add("laj");
		  Set  interval= new LinkedHashSet();
		  Set  interval_ext = new LinkedHashSet();
		  mapFname2Class.put("interval",interval);
		  mapFname2Ext.put("interval",interval_ext );
		  interval.add("Interval(Tabular)");
		  interval_ext.add("interval");
		  interval.add("BedGraph(Interval)");
		  interval_ext.add("bedgraph");
		  interval.add("Bed(Interval)");
		  interval_ext.add("bed");
		  interval.add("ProBed(Bed)");
		  interval_ext.add("probed");
		  interval.add("BedStrict(Bed)");
		  interval_ext.add("bedstrict");
		  interval.add("Bed6(BedStrict)");
		  interval_ext.add("bed6");
		  interval.add("Bed12(BedStrict)");
		  interval_ext.add("bed12");
		  interval.add("_RemoteCallMixin(object)");
		  interval.add("Gff(Tabular, _RemoteCallMixin)");
		  interval_ext.add("gff");
		  interval.add("Gff3(Gff)");
		  interval_ext.add("gff3");
		  interval.add("Gtf(Gff)");
		  interval_ext.add("gtf");
		  interval.add("Wiggle(Tabular, _RemoteCallMixin)");
		  interval_ext.add("wig");
		  interval.add("CustomTrack(Tabular)");
		  interval_ext.add("customtrack");
		  interval.add("ENCODEPeak(Interval)");
		  interval_ext.add("encodepeak");
		  interval.add("ChromatinInteractions(Interval)");
		  interval_ext.add("chrint");
		  interval.add("ScIdx(Tabular)");
		  interval_ext.add("scidx");
		  Set  isa= new LinkedHashSet();
		  Set  isa_ext = new LinkedHashSet();
		  mapFname2Class.put("isa",isa);
		  mapFname2Ext.put("isa",isa_ext );
		  isa.add("_Isa(data.Data)");
		  isa.add("IsaTab(_Isa)");
		  isa_ext.add("isa-tab");
		  isa.add("IsaJson(_Isa)");
		  isa_ext.add("isa-json");
		  Set  metadata= new LinkedHashSet();
		  Set  metadata_ext = new LinkedHashSet();
		  mapFname2Class.put("metadata",metadata);
		  mapFname2Ext.put("metadata",metadata_ext );
		  Set  molecules= new LinkedHashSet();
		  Set  molecules_ext = new LinkedHashSet();
		  mapFname2Class.put("molecules",molecules);
		  mapFname2Ext.put("molecules",molecules_ext );
		  molecules.add("GenericMolFile(data.Text)");
		  molecules.add("MOL(GenericMolFile)");
		  molecules_ext.add("mol");
		  molecules.add("SDF(GenericMolFile)");
		  molecules_ext.add("sdf");
		  molecules.add("MOL2(GenericMolFile)");
		  molecules_ext.add("mol2");
		  molecules.add("FPS(GenericMolFile)");
		  molecules_ext.add("fps");
		  molecules.add("OBFS(Binary)");
		  molecules_ext.add("obfs");
		  molecules.add("DRF(GenericMolFile)");
		  molecules_ext.add("drf");
		  molecules.add("PHAR(GenericMolFile)");
		  molecules_ext.add("phar");
		  molecules.add("PDB(GenericMolFile)");
		  molecules_ext.add("pdb");
		  molecules.add("PDBQT(GenericMolFile)");
		  molecules_ext.add("pdbqt");
		  molecules.add("PQR(GenericMolFile)");
		  molecules_ext.add("pqr");
		  molecules.add("grd(data.Text)");
		  molecules_ext.add("grd");
		  molecules.add("grdtgz(Binary)");
		  molecules_ext.add("grd.tgz");
		  molecules.add("InChI(Tabular)");
		  molecules_ext.add("inchi");
		  molecules.add("SMILES(Tabular)");
		  molecules_ext.add("smi");
		  molecules.add("CML(GenericXml)");
		  molecules_ext.add("cml");
		  Set  mothur= new LinkedHashSet();
		  Set  mothur_ext = new LinkedHashSet();
		  mapFname2Class.put("mothur",mothur);
		  mapFname2Ext.put("mothur",mothur_ext );
		  mothur.add("Otu(Text)");
		  mothur_ext.add("mothur.otu");
		  mothur.add("Sabund(Otu)");
		  mothur_ext.add("mothur.sabund");
		  mothur.add("GroupAbund(Otu)");
		  mothur_ext.add("mothur.shared");
		  mothur.add("SecondaryStructureMap(Tabular)");
		  mothur_ext.add("mothur.map");
		  mothur.add("AlignCheck(Tabular)");
		  mothur_ext.add("mothur.align.check");
		  mothur.add("AlignReport(Tabular)");
		  mothur_ext.add("mothur.align.report");
		  mothur.add("DistanceMatrix(Text)");
		  mothur_ext.add("mothur.dist");
		  mothur.add("LowerTriangleDistanceMatrix(DistanceMatrix)");
		  mothur_ext.add("mothur.lower.dist");
		  mothur.add("SquareDistanceMatrix(DistanceMatrix)");
		  mothur_ext.add("mothur.square.dist");
		  mothur.add("PairwiseDistanceMatrix(DistanceMatrix, Tabular)");
		  mothur_ext.add("mothur.pair.dist");
		  mothur.add("Names(Tabular)");
		  mothur_ext.add("mothur.names");
		  mothur.add("Summary(Tabular)");
		  mothur_ext.add("mothur.summary");
		  mothur.add("Group(Tabular)");
		  mothur_ext.add("mothur.groups");
		  mothur.add("AccNos(Tabular)");
		  mothur_ext.add("mothur.accnos");
		  mothur.add("Oligos(Text)");
		  mothur_ext.add("mothur.oligos");
		  mothur.add("Frequency(Tabular)");
		  mothur_ext.add("mothur.freq");
		  mothur.add("Quantile(Tabular)");
		  mothur_ext.add("mothur.quan");
		  mothur.add("LaneMask(Text)");
		  mothur_ext.add("mothur.filter");
		  mothur.add("CountTable(Tabular)");
		  mothur_ext.add("mothur.count_table");
		  mothur.add("RefTaxonomy(Tabular)");
		  mothur_ext.add("mothur.ref.taxonomy");
		  mothur.add("ConsensusTaxonomy(Tabular)");
		  mothur_ext.add("mothur.cons.taxonomy");
		  mothur.add("TaxonomySummary(Tabular)");
		  mothur_ext.add("mothur.tax.summary");
		  mothur.add("Axes(Tabular)");
		  mothur_ext.add("mothur.axes");
		  mothur.add("SffFlow(Tabular)");
		  mothur_ext.add("mothur.sff.flow");
		  Set  msa= new LinkedHashSet();
		  Set  msa_ext = new LinkedHashSet();
		  mapFname2Class.put("msa",msa);
		  mapFname2Ext.put("msa",msa_ext );
		  msa.add("InfernalCM(Text)");
		  msa_ext.add("cm");
		  msa.add("Hmmer(Text)");
		  msa.add("Hmmer2(Hmmer)");
		  msa_ext.add("hmm2");
		  msa.add("Hmmer3(Hmmer)");
		  msa_ext.add("hmm3");
		  msa.add("HmmerPress(Binary)");
		  msa_ext.add("hmmpress");
		  msa.add("Stockholm_1_0(Text)");
		  msa_ext.add("stockholm");
		  msa.add("MauveXmfa(Text)");
		  msa_ext.add("xmfa");
		  Set  neo4j= new LinkedHashSet();
		  Set  neo4j_ext = new LinkedHashSet();
		  mapFname2Class.put("neo4j",neo4j);
		  mapFname2Ext.put("neo4j",neo4j_ext );
		  neo4j.add("Neo4j(Html)");
		  neo4j.add("Neo4jDB(Neo4j, Data)");
		  neo4j_ext.add("neostore");
		  neo4j.add("Neo4jDBzip(Neo4j, Data)");
		  neo4j_ext.add("neostore.zip");
		  Set  ngsindex= new LinkedHashSet();
		  Set  ngsindex_ext = new LinkedHashSet();
		  mapFname2Class.put("ngsindex",ngsindex);
		  mapFname2Ext.put("ngsindex",ngsindex_ext );
		  ngsindex.add("BowtieIndex(Html)");
		  ngsindex.add("BowtieColorIndex(BowtieIndex)");
		  ngsindex_ext.add("bowtie_color_index");
		  ngsindex.add("BowtieBaseIndex(BowtieIndex)");
		  ngsindex_ext.add("bowtie_base_index");
		  Set  phylip= new LinkedHashSet();
		  Set  phylip_ext = new LinkedHashSet();
		  mapFname2Class.put("phylip",phylip);
		  mapFname2Ext.put("phylip",phylip_ext );
		  phylip.add("Phylip(Text)");
		  phylip_ext.add("phylip");
		  Set  plant_tribes= new LinkedHashSet();
		  Set  plant_tribes_ext = new LinkedHashSet();
		  mapFname2Class.put("plant_tribes",plant_tribes);
		  mapFname2Ext.put("plant_tribes",plant_tribes_ext );
		  plant_tribes.add("Smat(Text)");
		  plant_tribes_ext.add("smat");
		  plant_tribes.add("PlantTribesKsComponents(Tabular)");
		  plant_tribes_ext.add("ptkscmp");
		  Set  proteomics= new LinkedHashSet();
		  Set  proteomics_ext = new LinkedHashSet();
		  mapFname2Class.put("proteomics",proteomics);
		  mapFname2Ext.put("proteomics",proteomics_ext );
		  proteomics.add("Wiff(Binary)");
		  proteomics_ext.add("wiff");
		  proteomics.add("PepXmlReport(Tabular)");
		  proteomics_ext.add("pepxml.tsv");
		  proteomics.add("ProtXmlReport(Tabular)");
		  proteomics_ext.add("protxml.tsv");
		  proteomics.add("ProteomicsXml(GenericXml)");
		  proteomics.add("PepXml(ProteomicsXml)");
		  proteomics_ext.add("pepxml");
		  proteomics.add("MzML(ProteomicsXml)");
		  proteomics_ext.add("mzml");
		  proteomics.add("NmrML(ProteomicsXml)");
		  proteomics_ext.add("nmrml");
		  proteomics.add("ProtXML(ProteomicsXml)");
		  proteomics_ext.add("protxml");
		  proteomics.add("MzXML(ProteomicsXml)");
		  proteomics_ext.add("mzxml");
		  proteomics.add("MzData(ProteomicsXml)");
		  proteomics_ext.add("mzdata");
		  proteomics.add("MzIdentML(ProteomicsXml)");
		  proteomics_ext.add("mzid");
		  proteomics.add("TraML(ProteomicsXml)");
		  proteomics_ext.add("traml");
		  proteomics.add("MzQuantML(ProteomicsXml)");
		  proteomics_ext.add("mzq");
		  proteomics.add("ConsensusXML(ProteomicsXml)");
		  proteomics_ext.add("consensusxml");
		  proteomics.add("FeatureXML(ProteomicsXml)");
		  proteomics_ext.add("featurexml");
		  proteomics.add("IdXML(ProteomicsXml)");
		  proteomics_ext.add("idxml");
		  proteomics.add("TandemXML(ProteomicsXml)");
		  proteomics_ext.add("tandem");
		  proteomics.add("UniProtXML(ProteomicsXml)");
		  proteomics_ext.add("uniprotxml");
		  proteomics.add("Mgf(Text)");
		  proteomics_ext.add("mgf");
		  proteomics.add("MascotDat(Text)");
		  proteomics_ext.add("mascotdat");
		  proteomics.add("ThermoRAW(Binary)");
		  proteomics_ext.add("raw");
		  proteomics.add("Msp(Text)");
		  proteomics_ext.add("msp");
		  proteomics.add("SPLibNoIndex(Text)");
		  proteomics_ext.add("splib_noindex");
		  proteomics.add("SPLib(Msp)");
		  proteomics_ext.add("splib");
		  proteomics.add("Ms2(Text)");
		  proteomics_ext.add("ms2");
		  proteomics.add("XHunterAslFormat(Binary)");
		  proteomics_ext.add("hlf");
		  proteomics.add("Sf3(Binary)");
		  proteomics_ext.add("sf3");
		  proteomics.add("ImzML(Binary)");
		  proteomics_ext.add("imzml");
		  proteomics.add("Analyze75(Binary)");
		  proteomics_ext.add("analyze75");
		  Set  qualityscore= new LinkedHashSet();
		  Set  qualityscore_ext = new LinkedHashSet();
		  mapFname2Class.put("qualityscore",qualityscore);
		  mapFname2Ext.put("qualityscore",qualityscore_ext );
		  qualityscore.add("QualityScore(data.Text)");
		  qualityscore_ext.add("qual");
		  qualityscore.add("QualityScoreSOLiD(QualityScore)");
		  qualityscore_ext.add("qualsolid");
		  qualityscore.add("QualityScore454(QualityScore)");
		  qualityscore_ext.add("qual454");
		  qualityscore.add("QualityScoreSolexa(QualityScore)");
		  qualityscore_ext.add("qualsolexa");
		  qualityscore.add("QualityScoreIllumina(QualityScore)");
		  qualityscore_ext.add("qualillumina");
		  Set  registry= new LinkedHashSet();
		  Set  registry_ext = new LinkedHashSet();
		  mapFname2Class.put("registry",registry);
		  mapFname2Ext.put("registry",registry_ext );
		  registry.add("ConfigurationError(Exception)");
		  registry.add("Registry(object)");
		  Set  sequence= new LinkedHashSet();
		  Set  sequence_ext = new LinkedHashSet();
		  mapFname2Class.put("sequence",sequence);
		  mapFname2Ext.put("sequence",sequence_ext );
		  sequence.add("SequenceSplitLocations(data.Text)");
		  sequence_ext.add("fqtoc");
		  sequence.add("Sequence(data.Text)");
		  sequence.add("Alignment(data.Text)");
		  sequence.add("Fasta(Sequence)");
		  sequence_ext.add("fasta");
		  sequence.add("csFasta(Sequence)");
		  sequence_ext.add("csfasta");
		  sequence.add("Fastg(Sequence)");
		  sequence_ext.add("fastg");
		  sequence.add("BaseFastq(Sequence)");
		  sequence_ext.add("fastq");
		  sequence.add("Fastq(BaseFastq)");
		  sequence_ext.add("fastq");
		  sequence.add("FastqSanger(Fastq)");
		  sequence_ext.add("fastqsanger");
		  sequence.add("FastqSolexa(Fastq)");
		  sequence_ext.add("fastqsolexa");
		  sequence.add("FastqIllumina(Fastq)");
		  sequence_ext.add("fastqillumina");
		  sequence.add("FastqCSSanger(Fastq)");
		  sequence_ext.add("fastqcssanger");
		  sequence.add("Maf(Alignment)");
		  sequence_ext.add("maf");
		  sequence.add("MafCustomTrack(data.Text)");
		  sequence_ext.add("mafcustomtrack");
		  sequence.add("Axt(data.Text)");
		  sequence_ext.add("axt");
		  sequence.add("Lav(data.Text)");
		  sequence_ext.add("lav");
		  sequence.add("RNADotPlotMatrix(data.Data)");
		  sequence_ext.add("rna_eps");
		  sequence.add("DotBracket(Sequence)");
		  sequence_ext.add("dbn");
		  sequence.add("Genbank(data.Text)");
		  sequence_ext.add("genbank");
		  sequence.add("MemePsp(Sequence)");
		  sequence_ext.add("memepsp");
		  Set  sniff= new LinkedHashSet();
		  Set  sniff_ext = new LinkedHashSet();
		  mapFname2Class.put("sniff",sniff);
		  mapFname2Ext.put("sniff",sniff_ext );
		  sniff_ext.add("run_sniffers_raw(file_prefix, sniff_order, is_binary)");
		  sniff_ext.add("None");
		  sniff.add("FilePrefix(object)");
		  sniff.add("InappropriateDatasetContentError(Exception)");
		  Set  tabular= new LinkedHashSet();
		  Set  tabular_ext = new LinkedHashSet();
		  mapFname2Class.put("tabular",tabular);
		  mapFname2Ext.put("tabular",tabular_ext );
		  tabular.add("TabularData(data.Text)");
		  tabular.add("Tabular(TabularData)");
		  tabular.add("Taxonomy(Tabular)");
		  tabular.add("Sam(Tabular)");
		  tabular_ext.add("sam");
		  tabular.add("Pileup(Tabular)");
		  tabular_ext.add("pileup");
		  tabular.add("BaseVcf(Tabular)");
		  tabular.add("Vcf(BaseVcf)");
		  tabular_ext.add("vcf");
		  tabular.add("VcfGz(BaseVcf, binary.Binary)");
		  tabular_ext.add("vcf_bgzip");
		  tabular.add("Eland(Tabular)");
		  tabular_ext.add("_export.txt.gz");
		  tabular.add("ElandMulti(Tabular)");
		  tabular_ext.add("elandmulti");
		  tabular.add("FeatureLocationIndex(Tabular)");
		  tabular_ext.add("fli");
		  tabular.add("BaseCSV(TabularData)");
		  tabular.add("CSV(BaseCSV)");
		  tabular_ext.add("csv");
		  tabular.add("TSV(BaseCSV)");
		  tabular_ext.add("tsv");
		  tabular.add("ConnectivityTable(Tabular)");
		  tabular_ext.add("ct");
		  Set  text= new LinkedHashSet();
		  Set  text_ext = new LinkedHashSet();
		  mapFname2Class.put("text",text);
		  mapFname2Ext.put("text",text_ext );
		  text.add("Html(Text)");
		  text_ext.add("html");
		  text.add("Json(Text)");
		  text_ext.add("json");
		  ...
		  text.add("Arff(Text)");
		  text_ext.add("arff");
		  text.add("SnpEffDb(Text)");
		  text_ext.add("snpeffdb");
		  text.add("SnpSiftDbNSFP(Text)");
		  text_ext.add("snpsiftdbnsfp");
		  text.add("IQTree(Text)");
		  text_ext.add("iqtree");
		  Set  tracks= new LinkedHashSet();
		  Set  tracks_ext = new LinkedHashSet();
		  mapFname2Class.put("tracks",tracks);
		  mapFname2Ext.put("tracks",tracks_ext );
		  tracks.add("GeneTrack(binary.Binary)");
		  tracks_ext.add("genetrack");
		  tracks.add("UCSCTrackHub(Html)");
		  tracks_ext.add("trackhub");
		  Set  triples= new LinkedHashSet();
		  Set  triples_ext = new LinkedHashSet();
		  mapFname2Class.put("triples",triples);
		  mapFname2Ext.put("triples",triples_ext );
		  triples.add("Triples(data.Data)");
		  triples_ext.add("triples");
		  triples.add("NTriples(data.Text, Triples)");
		  triples_ext.add("nt");
		  triples.add("N3(data.Text, Triples)");
		  triples_ext.add("n3");
		  triples.add("Turtle(data.Text, Triples)");
		  triples_ext.add("ttl");
		  triples.add("Rdf(xml.GenericXml, Triples)");
		  triples_ext.add("rdf");
		  triples.add("Jsonld(text.Json, Triples)");
		  triples_ext.add("jsonld");
		  triples.add("HDT(binary.Binary, Triples)");
		  triples_ext.add("hdt");
		  Set  upload_util= new LinkedHashSet();
		  Set  upload_util_ext = new LinkedHashSet();
		  mapFname2Class.put("upload_util",upload_util);
		  mapFname2Ext.put("upload_util",upload_util_ext );
		  upload_util.add("UploadProblemException(Exception)");
		  Set  xml= new LinkedHashSet();
		  Set  xml_ext = new LinkedHashSet();
		  mapFname2Class.put("xml",xml);
		  mapFname2Ext.put("xml",xml_ext );
		  xml.add("GenericXml(data.Text)");
		  xml_ext.add("xml");
		  xml.add("MEMEXml(GenericXml)");
		  xml_ext.add("memexml");
		  xml.add("CisML(GenericXml)");
		  xml_ext.add("cisml");
		  xml.add("Phyloxml(GenericXml)");
		  xml_ext.add("phyloxml");
		  xml.add("Owl(GenericXml)");
		  xml_ext.add("owl");
		  xml.add("Sbml(GenericXml)");
		  xml_ext.add("sbml");
