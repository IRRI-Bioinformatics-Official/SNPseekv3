...
public class WorkflowInputs {
  ...
  private boolean parameters_normalized=false;
  ...
  public boolean getParametersNormalized() {
    return parameters_normalized;
  }

  public void setParametersNormalized(boolean b) {
	    parameters_normalized=b;
  }
